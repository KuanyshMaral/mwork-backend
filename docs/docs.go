...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_domain_profile.CreateEmployerProfileRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/profiles/model": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные профиля модели",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_domain_profile.CreateModelProfileRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_domain_profile.CreateEmployerProfileRequest": {
            "type": "object",
            "required": [
                "company_name"
            ],
        ...
        "internal_domain_profile.CreateModelProfileRequest": {
            "type": "object",
            "required": [
                "city",
                "name"
