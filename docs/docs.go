...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/casting-promotions": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные продвижения",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_domain_promotion.CreateCastingPromotionRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/internal_domain_promotion.CastingPromotionResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/casting-promotions/{id}/activate": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "internal_domain_promotion.CastingPromotionResponse": {
            "type": "object",
            "properties": {
                "budget_amount": {
                    "type": "integer"
        ...
        "internal_domain_promotion.CreateCastingPromotionRequest": {
            "type": "object",
            "required": [
                "budget_amount",
                "casting_id",
