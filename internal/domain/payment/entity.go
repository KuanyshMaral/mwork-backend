...
const (
	ProviderRoboKassa Provider = "robokassa" // Primary payment provider (active since Feb 9, 2026)
	ProviderKaspi     Provider = "kaspi"     // DEPRECATED: Removed Feb 9, 2026. Use RoboKassa instead.
...
type Payment struct {
	...
	// RoboKassa invoice ID (new)
	RoboKassaInvID *int64 `db:"robokassa_inv_id" json:"robokassa_inv_id,omitempty"`
	// DEPRECATED: KaspiOrderID is no longer used. Kept for historical data queries only.
	// Migration away from Kaspi completed Feb 9, 2026. This field will be removed in v2.0.0 (May 2026).
	// Do NOT use for new payments or features.
