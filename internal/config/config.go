...
func Load() *Config {
	...
	return &Config{
		...
		RobokassaPassword1:          firstNonEmpty(getEnv("ROBOKASSA_PASSWORD_1", ""), getEnv("ROBOKASSA_PASSWORD1", "")),
		RobokassaPassword2:          firstNonEmpty(getEnv("ROBOKASSA_PASSWORD_2", ""), getEnv("ROBOKASSA_PASSWORD2", "")),
